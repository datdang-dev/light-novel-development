...
- **Architecture Diagram:** `{{project_root}}/studio/docs/architecture/dynamic_design/service_manga_adapter/sq_v6_1_gooner_alchemist_pipeline.puml`
...
- **Delegation Protocol:** Read `{{project_root}}/studio/docs/protocols/delegation-protocol.md` when handing off tasks.
