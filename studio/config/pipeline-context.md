...
*(Note: These files provide contextual framing. Rely on them as guidelines and use specific `knowledge_payload.md` drops from the Orchestrator for scene-specific parameters.)*
