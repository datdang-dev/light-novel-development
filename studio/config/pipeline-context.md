...
- **Prose Rules:** Read `{project-root}/studio/rules/prose_structure.md` for standard metadata blocks and formatting.
- **Lewd Mechanics:** Read `{project-root}/studio/rules/lewd_writing_mechanics.md` when writing prose.
- **Sensory Bounds:** Read `{project-root}/studio/rules/sensory_density.md` for density constraints.
