...
| ----------------- | --------------------------------- | ----- | -------------------------------------------------------------------------------------- |
| `/panel-forensic` | `core/panel-forensic/SKILL.md`    | Kana  | Deep visual extraction (ATOMIC matrix) from images — objects, fluids, panel flow, SFX. |
