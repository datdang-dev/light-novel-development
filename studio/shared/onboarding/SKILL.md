...
1. Load config from `{{project_root}}/studio/config/config.yaml`
...
| 3 | Active Project State | Scan `{{run_dir}}/_pipeline/` for `state.yaml` |
| 4 | Character Bible | Scan `{{run_dir}}/_bible/` for character profiles |
