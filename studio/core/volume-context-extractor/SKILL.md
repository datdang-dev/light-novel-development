...
4. Run a synthesis step to generate a structured timeline mapping character dialogues, actions, and key plot points into `{{project_root}}/studio/output/volume_context.md`.
...
5. Synthesize your observations directly into `{{project_root}}/studio/output/volume_context.md`.

## 4. Final Output Construction
The final artifact MUST be saved to `{{project_root}}/studio/output/volume_context.md` containing:
