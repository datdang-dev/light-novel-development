...
- **SFX Rotation:** Reference `{{project_root}}/studio/rules/rp_sfx_registry.md`. Never repeat same SFX in consecutive turns.
...
**Prompt Instruction:**
All output MUST use distinct formatting blocks (full spec in `{{project_root}}/studio/rules/rp_novel_format.md`):
