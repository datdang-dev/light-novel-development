...
outputFile: '{{run_dir}}/_analysis/{{manga_name}}/page_{{page_num}}_forensics.md'
---
...
- 👁️ **DEGENERATE GROUND TRUTH:** Mặc dù phải dựa trên hình ảnh thực tế trên trang truyện, bạn KHÔNG ĐƯỢC nhìn vật thể bằng cái tên bề ngoài "an toàn" của nó. Hãy tra vấn hình học và bối cảnh (ví dụ: Nếu vật thể lấp lánh treo ở núm vú, nó không thể là trang sức thường, mà là vật chứa dịch tiết). Bắt buộc phải thực hiện bước Audit.
...
### 3.4 Degenerate Lens Interrogation (Audit) BẮT BUỘC
- Liệt kê các vật thể "có vẻ an toàn" (đá quý, kẹo, nước, dây thừng, đồ chơi) và giải trình theo lăng kính R18.
- **Vật thể A:** [Mô tả hình học] -> [Giải thích tại sao KHÔNG PHẢI đồ vật thường dựa trên bối cảnh R18] -> [Kết luận đồ R18 thực sự].
- *(Ví dụ: Vật thể tím hình giọt nước treo ở núm vú -> Trang sức thường không chứa chất lỏng và treo ở vị trí dâm dục -> Bao cao su chứa tinh trùng tím).*
```text
