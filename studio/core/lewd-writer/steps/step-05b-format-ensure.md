...
outputFile: '{{run_dir}}/_prose/{{manga_name}}/chapter_{{ch}}/page_{{page_num}}_prose.md'
templateFile: '{{project_root}}/studio/_templates/light-novel-prose.md'
dialogueRulesFile: '{{project_root}}/studio/rules/dialogue_format.md'
---
