...
- **Protocol:** Score the prose and generate a `continuity_update`. Execute: `agent -f {{project_root}}/studio/core/party-mode/riko-workspace/.cursorrules "Read draft-prose.json and continuity-ledger.json. Output strict JSON."`
