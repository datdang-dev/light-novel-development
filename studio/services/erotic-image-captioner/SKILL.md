...
description: "Lightweight 4-step pipeline: Image → Forensic Analysis (Kana) → Scene Prelude (Luna) → Erotic Caption (Suki Caption Mode with Mood Seed). Outputs short, explicit R18 image captions with narrative context."
injection:
  always:
...
dependencies:
  core:
    - path: "{{project_root}}/studio/core/panel-forensic/SKILL.md"
    - path: "{{project_root}}/studio/core/scene-prelude/SKILL.md"
    - path: "{{project_root}}/studio/core/erotic-caption-writer/SKILL.md"
  config:
    - path: "{{project_root}}/studio/config/canon-rules.md"
---
