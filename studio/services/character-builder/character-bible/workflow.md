...
- **Full Principles & Output Format:** [See workflow-OLD.md](./workflow-OLD.md)
...
IT IS CRITICAL THAT YOU FOLLOW THIS COMMAND: LOAD the FULL @{project-root}/studio/services/character-builder/character-bible/steps/step-01-input-mode.md, READ its entire contents and follow its directions exactly!
