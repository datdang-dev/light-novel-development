...
bibleSyncWorkflow: '{{project_root}}/studio/services/bible-sync/references/workflow.md'
...
ALWAYS LOAD (Tier 1 — Core, ~500 tokens):
  ...
  ✅ {{project_root}}/studio/schemas/draft-prose.schema.json (structure only)
...
IF scene_tags CONTAINS "bedroom" OR "bathroom" OR "explicit":
  ...
  ✅ {{project_root}}/studio/core/lewd-writer/data/sensory-vocabulary.md

IF scene_tags CONTAINS "dialogue-heavy" OR "confrontation":
  ✅ {{project_root}}/studio/rules/character_voice.md
  ✅ {{project_root}}/studio/rules/dialogue_format.md (full version)
