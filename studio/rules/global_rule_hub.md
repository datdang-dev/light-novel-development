...
* **Self-Reflection:** Agents handling Prose Generation (Suki) MUST internally evaluate their drafted prose against `{{project_root}}/studio/core/party-mode/riko-workspace/AUDIT_STANDARD_v2.md` and self-correct format/density failures *before* finalizing their draft.
