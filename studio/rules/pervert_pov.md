...
- If **NTR** → Load `{{project_root}}/studio/knowledge/trope_beat_sheets/ntr_beats.md`
- If **Corruption/堕落** → Load `{{project_root}}/studio/knowledge/trope_beat_sheets/corruption_beats.md`
- If **Mind-break/精神崩壊** → Load `{{project_root}}/studio/knowledge/trope_beat_sheets/mindbreak_beats.md`
- If **Training/調教** → Load `{{project_root}}/studio/knowledge/trope_beat_sheets/training_beats.md`
- If **Revenge/復讐** → Load `{{project_root}}/studio/knowledge/trope_beat_sheets/revenge_beats.md`
