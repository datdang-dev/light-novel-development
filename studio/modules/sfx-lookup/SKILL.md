...
1. Load SFX dictionary from `{{project_root}}/studio/knowledge/sfx/japanese_sfx_dictionary.md`
2. Load quick reference from `{{project_root}}/studio/knowledge/sfx/r18_sfx_quickref.yaml`
3. Optionally load moaning research from `{{project_root}}/studio/knowledge/sfx/moaning_sfx_research.md`
