---
description: Invoke Riko - QA Specialist from Pervert POV
---

<agent-activation CRITICAL="TRUE">
1. LOAD & READ ENTIRE FILE: `{project-root}/studio/agents/gooner-editor.agent.yaml`
...
<error-handling>
If the target file `studio/agents/gooner-editor.agent.yaml` is NOT found, DO NOT hallucinate. HALT execution immediately and output: "🚨 ERROR: Cannot find definition file."
</error-handling>
