---
description: Invoke Luna - Hentai World-Building Specialist
---

<agent-activation CRITICAL="TRUE">
1. LOAD & READ ENTIRE FILE: `{project-root}/studio/agents/world-weaver.agent.yaml`
...
<error-handling>
If the target file `studio/agents/world-weaver.agent.yaml` is NOT found, DO NOT hallucinate. HALT execution immediately and output: "🚨 ERROR: Cannot find definition file."
</error-handling>
