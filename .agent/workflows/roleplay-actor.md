...
1. LOAD & READ ENTIRE FILE: `{project-root}/studio/agents/roleplay-actor.agent.yaml`
...
<error-handling>
If the target file `studio/agents/roleplay-actor.agent.yaml` is NOT found, DO NOT hallucinate. HALT execution immediately and output: "🚨 ERROR: Cannot find definition file."
</error-handling>
